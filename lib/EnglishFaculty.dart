...
class EnglishFaculty extends StatefulWidget {
  @override
  _EnglishFacultyState createState() => _EnglishFacultyState();
}

class _EnglishFacultyState extends State<EnglishFaculty> {
  @override
