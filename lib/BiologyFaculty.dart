...
class BiologyFaculty extends StatefulWidget {
  @override
  _BiologyFacultyState createState() => _BiologyFacultyState();
}

class _BiologyFacultyState extends State<BiologyFaculty> {
  @override
