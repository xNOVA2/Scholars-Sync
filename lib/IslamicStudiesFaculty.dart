...
class IslamicStudiesFaculty extends StatefulWidget {
  @override
  _IslamicStudiesFacultyState createState() => _IslamicStudiesFacultyState();
}

class _IslamicStudiesFacultyState extends State<IslamicStudiesFaculty> {
  @override
